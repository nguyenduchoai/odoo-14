...
$ curl -s https://raw.githubusercontent.com/nguyenduchoai/odoo-14/master/run.sh | sudo bash -s odoo-14-docker-compose-one 10014

# 2nd Odoo @ localhost:11014
$ curl -s https://raw.githubusercontent.com/nguyenduchoai/odoo-14/master/run.sh | sudo bash -s odoo-14-docker-compose-two 11014
```
...
admin_passwd = 123.456
```

* Default database password (**admin_passwd**) is `123.456`, please change it!
